...
export default function AboutPage() {
  return <>
    <section className="bg-uoft-ice pt-40 pb-24"><div className="container-shell"><h1 className="display max-w-4xl text-uoft-navy">About us</h1><p className="body-lg mt-7 max-w-3xl">CAGH UTM creates space for students from across UTM to explore global health through community, research, dialogue, mentorship and action.</p></div></section>
